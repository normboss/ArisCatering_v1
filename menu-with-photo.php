...
<head>
    ...
    <link href="../css/menu-with-photo.css" media="screen" rel="stylesheet" type="text/css">
...
<body>
    <main>
        <div class="top-section">
            ...
            <div class="box pickup">
                *Pickup, or 3+ orders delivered for additional $5.99, Monday&nbsp;thru&nbsp;Friday
            </div>
        ...
        <div id="menu-section" class="menu-section">
            <div class="meal-photo">
                <!-- <img src="../images/tape-cropped1-white-sm.png" alt=""> -->
                <div id="inner-meal-photo" class="inner-meal-photo">
                    <!-- <img src="../images/foodiesfeed.com_tacos-with-pulled-pork-fresh-vegetables-and-cream.jpg"> -->
                </div>
            </div>
    ...
    <script>
        // var blackboard = document.getElementById('menu-section');
        // var height = blackboard.offsetHeight;
        // var newHeight = height + 200;
        // blackboard.style.height = newHeight + 'px';
        // height = blackboard.offsetHeight;
        // height = newHeight;

        var innerMealPhoto = document.getElementById('inner-meal-photo');
        innerMealPhoto.style.backgroundImage = "url('../images/foodiesfeed.com_tacos-with-pulled-pork-fresh-vegetables-and-cream.jpg')";
    </script>
