...
<head>
    ...
    <link href="../css/udpate-menu-with-photo.css" media="screen" rel="stylesheet" type="text/css">
        ...
        <form action="update.php" method="post">
            ...
            <div class="menu-section">
                ...
                <div class="meal-photo">
                    <div class="inner-meal-photo">
                        <textarea name="" rows="1" cols="20">Enter filename of photo</textarea>
                    </div>
                </div>
